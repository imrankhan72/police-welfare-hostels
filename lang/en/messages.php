...
return [
    ...
    'copy_right'=>'© Copyright 2023 | Police Welfare Hostels | All Rights Reserved',
    ...
    "apply-form"=>"Apply For Accommodation",
    "contact_us"=>"Contact Us",
    "about_us_page" => "
...
"police-title"=>"Who is in the Police Service? Mother/ Father",
...
"p-station"=>"Posted Police Station/Office",
"lg"=>"Local Guardian (if any)",
"g-name"=>"Name",
"g-relation"=>"Relation with Guardian",
"g-mobile"=>" Mobile No.",
"g-address"=>"Address",
"attachment"=>"Attachment Checklist",
"note"=>"Note: Attachments should not exceed 500 KB and be in JPG, JEPG, and PNG formats.",
"a-photo"=>"Coloured Passport Size Photo",
"a-aadhar"=>"Copy of Aadhaar Card",
"a-10th"=>"Copy of 10th Marksheets",
"a-12th"=>"Copy of 12th Marksheets",
"a-parent-id"=>"Copy of mother/father's police identity card",
...
"gwalior_address"=>"<h3>Gwalior</h3>
                    <p><b>Address-</b> Police Welfare Hostel, Aamkho Pahadiya, Near Water Tank, Lashkar, Gwalior- 474009</p>
                    <p><b>Email-</b> -</p>
